export const revisionID = 'ce93cc0f9cd5';

export const sqlCommands_12012024161045869715_ce93cc0f9cd5: string[] = [
  ...
  `CREATE TABLE exercise_bodypart (
	    exercise_bodypart_id INTEGER NOT NULL,
	    exercise_id INTEGER NOT NULL,
  ...
  `CREATE TABLE plan_component (
	    plan_component_id INTEGER NOT NULL,
	    name VARCHAR(100) NOT NULL,
	    description VARCHAR(500),
	    plan_id INTEGER NOT NULL,
	    created_at TIMESTAMP NOT NULL,
  ...
  `CREATE TABLE set_component (
	    set_component_id INTEGER NOT NULL,
	    name VARCHAR(100) NOT NULL,
  ...
  "INSERT INTO alembic_version (version_num) VALUES ('ce93cc0f9cd5');",
];
